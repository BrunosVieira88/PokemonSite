...
<header>
	      ...
	      <ul class="navbar-nav">
	        ...
	        <li class="nav-item dropdown">
	          ...
	          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
	            ...
	            <li><a class="dropdown-item" href="/todospoke">Todas as gerações</a></li>
	          </ul>
	        </li>
	      </ul>
	    </nav>
	...
	<div>
		<div class="container">
			<img src="/imagens/pokemon.jpg" alt="" style="width:82%; height:50%;position:absolute;">
		</div>
		<div id="logo_header"   class="align-itens-center">
			<h1>Pokémon </h1>
			<div>
				<img  src="imagens/pikachu.png" style="width:130px;border-radius:70%;">
			</div>
...
<section class="container" style="position: relative;margin-top:25%">
